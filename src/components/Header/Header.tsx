        ...
        <Offcanvas show={show} onHide={handleClose} scroll={true} backdrop={true} placement="end" style={{
          ...
          <Offcanvas.Body style={{
            ...
            <Navbar.Brand onClick={goToHome} style={{ color: "#fde1c1", width: "100%",cursor:"pointer", display: "block", borderTop: "solid", margin: "0", padding: "5px" }}>
              <FontAwesomeIcon icon={faHome} style={{ fontSize: "1.2em", color: "fde1c1", marginRight: "30px", }} />
              Inicio
            </Navbar.Brand>
            <Navbar.Brand onClick={goToList} style={{ color: "#fde1c1", width: "100%",cursor:"pointer", display: "block", borderTop: "solid", margin: "0", padding: "5px" }}>
              <FontAwesomeIcon icon={faUtensils} style={{ fontSize: "1.2em", color: "fde1c1", marginRight: "35px", }} />
              Lista de platos
            </Navbar.Brand>
            <Navbar.Brand onClick={goToLogin} style={{ color: "#fde1c1", width: "100%",cursor:"pointer", display: "block", borderTop: "solid", margin: "0", padding: "5px" }}>
              <FontAwesomeIcon icon={faUser} style={{ fontSize: "1.2em", color: "fde1c1", marginRight: "35px", }} />
              Login
            </Navbar.Brand>
            <Navbar.Brand onClick={goToSub} style={{ color: "#fde1c1", width: "100%",cursor:"pointer", display: "block", borderTop: "solid", margin: "0", padding: "5px" }}>
              <FontAwesomeIcon icon={faEuroSign} style={{ fontSize: "1.2em", color: "fde1c1", marginRight: "40px", }} />
              Suscripciones
            </Navbar.Brand>
            <Navbar.Brand onClick={goToCart} style={{ color: "#fde1c1", width: "100%",cursor:"pointer", display: "block", borderTop: "solid", borderBottom: "solid", margin: "0", padding: "5px" }}>
              <FontAwesomeIcon icon={faCartShopping} style={{ fontSize: "1.2em", color: "fde1c1", marginRight: "30px", }} />
              Carrito
            </Navbar.Brand>
          </Offcanvas.Body>
        </Offcanvas>
